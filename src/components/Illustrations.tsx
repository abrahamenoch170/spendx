...
export const LinkExpand = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
    ...
    {/* Expanding Link */}
    <motion.rect x="40" y="50" width="20" height="10" rx="2" stroke="var(--cyan)" 
      animate={{ width: [20, 50, 20], height: [10, 40, 10], x: [40, 25, 40], y: [50, 45, 50] }} 
      transition={{ repeat: Infinity, duration: 4, ease: "easeInOut" }} 
    />
    <motion.path d="M 45 55 L 55 55" stroke="var(--magenta)" animate={{ opacity: [1, 0, 1] }} transition={{ repeat: Infinity, duration: 2 }} />
  </svg>
);
...
export const SquadFigures = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
    ...
    {/* Phone glow */}
    <motion.circle cx="50" cy="50" r="8" fill="var(--lime)" fillOpacity="0.3" stroke="none" animate={{ scale: [1, 1.5, 1] }} transition={{ repeat: Infinity, duration: 2 }} />
  </svg>
);
...
export const BigGroup = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
    ...
    {/* Sound waves */}
    <motion.path d="M 58 42 Q 62 50 58 58 M 65 38 Q 72 50 65 62" stroke="var(--magenta)" animate={{ opacity: [0, 1, 0], x: [0, 5, 0] }} transition={{ repeat: Infinity, duration: 1.5 }} />
  </svg>
);
...
export const DateFigures = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
    ...
    {/* Candle/Heart */}
    <motion.path d="M 50 55 Q 55 50 50 65 Q 45 50 50 55 Z" fill="var(--magenta)" stroke="none" animate={{ scale: [1, 1.2, 1] }} transition={{ repeat: Infinity, duration: 2 }} />
  </svg>
);
...
export const MapPulse = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
    ...
    <motion.circle cx="50" cy="45" r="25" stroke="var(--lime)" animate={{ scale: [0.8, 1.5], opacity: [1, 0] }} transition={{ repeat: Infinity, duration: 2 }} />
  </svg>
);
...
export const CleanMath = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
    ...
    <motion.path d="M 60 60 L 65 65 L 75 50" stroke="var(--cyan)" strokeWidth="4" animate={{ pathLength: [0, 1, 1], y: [0, -5, 0] }} transition={{ repeat: Infinity, duration: 2.5 }} />
  </svg>
);
...
export const RideArrives = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
    {/* Route Draw */}
    <motion.path d="M 10 80 Q 30 60 50 75 T 90 60" stroke="var(--magenta)" strokeDasharray="100" animate={{ strokeDashoffset: [100, 0, 0] }} transition={{ repeat: Infinity, duration: 3 }} />
    {/* Car */}
...
export const ShareLink = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
    {/* Shuffling Cards */}
    <motion.path d="M 20 40 Q 40 35 60 40 L 55 70 Q 35 75 15 70 Z" fill="var(--teal)" fillOpacity="0.2" animate={{ rotate: [-5, 5, -5], x: [-2, 2, -2] }} transition={{ repeat: Infinity, duration: 3 }} />
    <motion.path d="M 30 30 Q 50 25 70 30 L 65 60 Q 45 65 25 60 Z" fill="var(--lime)" fillOpacity="0.2" animate={{ rotate: [5, -5, 5], x: [2, -2, 2] }} transition={{ repeat: Infinity, duration: 3, delay: 0.5 }} />
    {/* Share Arrow */}
    <motion.path d="M 40 60 L 70 30 M 70 30 L 55 30 M 70 30 L 70 45" stroke="var(--magenta)" strokeWidth="4" animate={{ x: [0, 5, 0], y: [0, -5, 0] }} transition={{ repeat: Infinity, duration: 1.5 }} />
  </svg>
);
...
export const BudgetIcon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M 50 40 V 60 M 45 45 Q 55 40 55 50 Q 45 60 55 55" stroke="var(--magenta)" />
  </svg>
);
...
export const FallingApartIcon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 100 100" className={className} fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
    ...
    <motion.path d="M 40 50 L 60 50" stroke="var(--magenta)" animate={{ rotate: [-20, 20, -20] }} transition={{ repeat: Infinity, duration: 0.5 }} />
  </svg>
);
